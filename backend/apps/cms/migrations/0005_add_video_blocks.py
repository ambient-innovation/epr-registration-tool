...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cms', '0004_add_background_to_pdf_download_block'),
    ]
            ...
            field=wagtail.fields.StreamField(
                [
                    ...
                    (
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ('video_url', wagtail.blocks.URLBlock(help_text='YouTube video URL')),
                                (
                                    'heading',
                                    wagtail.blocks.CharBlock(
                                        help_text='Check for optical impacts on the video thumbnail before adding a '
                                        'heading',
                                        required=False,
                                    ),
                                ),
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    'orientation',
                                    wagtail.blocks.ChoiceBlock(
                                        choices=[('textFirst', 'Text first'), ('videoFirst', 'Video first')]
                                    ),
                                ),
                                (
                                    'background',
